...
class AnagramsSuite {
  ...
  @Test def `sentenceOccurrences: abecd e (5pts)`: Unit =
    assertEquals(List(('a', 1), ('b', 1), ('c', 1), ('d', 1), ('e', 2)), sentenceOccurrences(List("abecd", "e")))
  ...
  @Test def `subtract: lard - rd (10pts)`: Unit = {
    val lard = List(('a', 1), ('d', 1), ('l', 1), ('r', 1))
    val r = List(('r', 1), ('d', 1))
  ...
  @Test def `subtract: lard - rd 2 (10pts)`: Unit = {
    val lard = List(('a', 2), ('d', 3), ('l', 1), ('r', 1))
    val r = List(('r', 1), ('d', 1), ('a', 1))
  ...
  @Test def `sentence anagrams: yes man (10pts)`: Unit = {
